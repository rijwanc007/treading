@extends('master')
@section('content')
    {!! Form::open(['class' =>'form-sample','route' => ['purchase_account.update',$edit->id],'method' => 'PATCH','enctype' => 'multipart/form-data']) !!}
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-6">
            <div class="page-header" id="bannerClose"><h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white mr-2"><i class="mdi mdi-account"></i></span> Update Purchase Account</h3></div>
            <div class="card">
                <div class="card-body">
                    <div><img class="product_image" src="{{asset('assets/images/purchase/'.$edit->image)}}" alt="dealer_image"/></div><br/>
