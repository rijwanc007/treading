                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="ban" name="ban" value=0>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="packing">Packing :</label>
                                    <input type="number" class="form-control" id="packing" name="packing" value=0>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="belt">Belt :</label>
                                    <input type="number" class="form-control" id="belt" name="belt" value=0>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="labour">Labour :</label>
                                    <input type="number" class="form-control" id="labour" name="labour" value=0>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="transport">Transport :</label>
                                    <input type="number" class="form-control" id="transport" name="transport" value=0>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="amount">Amount :</label>
                                    <input type="number" class="form-control" id="amount" name="amount"  value=0 readonly required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="commission">Commission :</label>
                                    <input type="number" class="form-control " id="commission" name="commission" value=0>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
