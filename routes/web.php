...
Route::group(['middleware' => ['preventbackbutton','auth']],function() {
    ...
    Route::get('warehouse-index','Admin\WarehouseController@index')->name('warehouse_index');
    Route::get('warehouse-create','Admin\WarehouseController@create')->name('warehouse_create');
});
